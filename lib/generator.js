...
function parseStatement(statement, declarations) {
  ...
  if (isFunctionDeclaration(statement, doc.tags)) {
    ...
    if (className) {
      moduleInfo.classIndex[className].methods.push(functionInfo);
    } else {
